...
class LangChainAvatarService:
    ...
    def create_mentor_prompt(self, language: str = "en-IN") -> ChatPromptTemplate:
        ...
        system_template = (
            ...
            f"The mentee has selected the language: {target_lang} ({target_script}).\n"
            f"You MUST formulate your entire spoken explanation 100% EXCLUSIVELY in pure, native, grammatically impeccable {target_lang}.\n\n"
