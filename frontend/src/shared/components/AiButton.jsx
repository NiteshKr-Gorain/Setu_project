  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40 flex items-center group">
        ...
        {/* Ambient Ring Glow */}
        <div className="absolute -inset-1.5 bg-gradient-to-r from-[#6366F1] via-indigo-400 to-[#4F46E5] rounded-full blur-md opacity-70 group-hover:opacity-100 group-hover:blur-lg transition-all duration-300 animate-pulse pointer-events-none"></div>
        ...
        <button
          ...
          className="relative w-14 h-14 rounded-full bg-gradient-to-br from-[#6366F1] via-indigo-500 to-[#4F46E5] text-white shadow-xl shadow-indigo-500/40 hover:shadow-2xl hover:shadow-indigo-500/60 flex items-center justify-center border-2 border-white/40 transform hover:scale-110 active:scale-95 transition-all duration-300 cursor-pointer overflow-hidden"
        >
